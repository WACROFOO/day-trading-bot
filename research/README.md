...
| `megaday-study/` | Le plan de l'étude sur les 250+ megadays en barres 1 min : holdout gelé d'abord, anatomie descriptive, taux de base sans gates, segmentation par type de journée, 3-5 hypothèses pré-enregistrées, une seule passe de validation avec la règle de décision écrite d'avance |
