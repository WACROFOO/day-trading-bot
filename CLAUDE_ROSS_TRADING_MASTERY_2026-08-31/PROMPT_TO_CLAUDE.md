...
- `references/platform-rebuild-audit.md` for the captured workstation requirements and clean-room reconstruction boundary.
- `references/scanner-alert-platform-spec.md` for the implementation-ready formulas, event contracts, notification engine, database/API design, tests and phased build plan.
...
When helping rebuild a personal workstation, use `references/platform-rebuild-audit.md` for the requirements audit and `references/scanner-alert-platform-spec.md` as the authoritative implementation plan. Separate:
