...
7. Read `references/platform-rebuild-audit.md` when designing a scanner-first workstation, choosing chart/data/news/Level 2 components, specifying APIs, or planning a clean-room platform build.
8. Read `references/source-analysis.md` when discussing scanner internals, thresholds, source code, or calibration.
9. Read `references/tradingview-setup.md` and inspect `assets/ross_style_momentum_scanner.pine` before changing or installing the TradingView implementation.
10. Reconcile new information with existing knowledge. Preserve earlier confirmed facts unless stronger evidence supersedes them.
